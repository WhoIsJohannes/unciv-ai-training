# Self-play v5 — Continual Training — Phase 1: Discovery

Progress tracker for Steps 0–3. Tick boxes and fill evidence after EVERY step.
Save this file to disk after each step.

> **Slug**: `selfplay-v5` | **Branch**: `selfplay-v5` | **Started**: 2026-06-25
> **Spec folder**: `specs/2026-06-25-selfplay-v5/` | **Mode**: _(Step 0)_ | **Size**: _(Step 0)_
...
fail ×3, policy violation. (5) Artifacts in `specs/2026-06-25-selfplay-v5/`. (6) Update
`FEATURE_STATE.json` after each step. (7) Log OpenRouter calls to `cost-log.jsonl`.
(8) **Telemetry**: log step start/end to `specs/2026-06-25-selfplay-v5/timings.jsonl`
(`{"step": N, "phase": 1, "event": "start|end", "ts": "..."}`).
(8b) **Q&A capture**: after every `AskUserQuestion` gate, append one line to
`specs/2026-06-25-selfplay-v5/questions.jsonl`: `{"ts", "phase", "step", "header", "question",
...
Look for `specs/2026-06-25-selfplay-v5/FEATURE_STATE.json`. If found: display progress, ask user via
...
cat > specs/2026-06-25-selfplay-v5/FEATURE_STATE.json << STATEEOF
{ "slug": "selfplay-v5", "started": "2026-06-25", "mode": "$MODE", "size": "$SIZE",
  "current_phase": 1, "current_step": 1, "last_completed_step": 0,
  "spec_dir": "specs/2026-06-25-selfplay-v5", "repo_root": "/Users/j/Unciv",
...
- [ ] Hooks configured
- [ ] In worktree on branch `selfplay-v5`
...
timeout 20 python3 -m lib.observability.recall \
  --query "Self-play v5 — Continual Training — selfplay-v5" --kind decision --repo-root "/Users/j/Unciv" --scope repo || true
timeout 20 python3 -m lib.observability.recall \
  --query "Self-play v5 — Continual Training — selfplay-v5" --kind answer --repo-root "/Users/j/Unciv" --scope repo || true
```
...
- [ ] Report saved to `specs/2026-06-25-selfplay-v5/codebase-scan-light.md`
...
Write `specs/2026-06-25-selfplay-v5/discovery-output.md`: Mode, Size, Feature (1-line), Context category,
