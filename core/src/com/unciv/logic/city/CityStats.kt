...
class CityStats(val city: City) {
    ...
    fun update(currentConstruction: IConstruction = city.cityConstructions.getCurrentConstruction(),
        ...
        // perf: also heavy, and previously computed TWICE with identical inputs (once inside
        // updateBaseStatList, once inside updateCityHappiness — only baseStatTree is assigned in
        // between, which neither reads). Compute once and share.
